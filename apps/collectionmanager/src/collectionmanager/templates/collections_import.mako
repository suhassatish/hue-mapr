    ...
    <div class="span9">
      <div class="card wizard">
        ...
        <div class="card-body">
          ...
          <a href="javascript:void(0)" class="btn btn-primary disable-feedback" data-bind="enable: selectedImportable().length > 0, click: importSelectedCollectionsAndCores">${ _('Import Selected') }</a>
...
function importSelectedCollectionsAndCores() {
  vm.importSelected().done(function(data) {
    if (data.status == 0) {
