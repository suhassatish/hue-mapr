      ...
      <ul class="nav nav-pills hueBreadcrumbBar" id="breadcrumbs">
        <li>
          <div style="display: inline" class="dropdown">
            ${_('App name')}&nbsp;
            <span data-bind="visible: ! $root.appNames().length > 0">${ _("Create one?") }</span>
        ...
        <li>
          <div style="display: inline" class="dropdown">
            ...
            <span data-bind="visible: ! $root.autoContext()">
              <span data-bind="visible: ! $root.contexts().length > 0">${ _("Create one?") }</span>
        ...
        <span class="pull-right">
		  <button type="button" class="btn btn-primary" id="uploadAppModalBtn">${ _('Upload app') }</button>
		  <button type="button" class="btn btn-primary" id="createContextModalBtn">${ _('Create context') }</button>
        </span>
      </ul>
    </div>
  </div>
