...
<script type="text/html" id="step-1">
  <div class="control-group" data-bind="css: {'error': collection.name.errors().length > 0}">
    ...
    <div class="controls">
      <input data-bind="value: collection.name.value" name="name" type="text" placeholder="${_('Name of collection')}" />
    </div>
  </div>
...
<script type="text/html" id="step-3">
  <formset data-bind="foreach: collection.fields">
    <div class="control-group" data-bind="css: {'error': name.errors().length > 0}">
      <label for="name" class="control-label">${_("Name")}</label>
      <div class="controls">
        <input data-bind="value: name.value" name="name" type="text" placeholder="${_('Name of field')}" />
      </div>
    </div>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <select data-bind="options: $root.fieldTypes, value: type.value" name="type"></select>
      </div>
    </div>
