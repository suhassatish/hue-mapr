...
class JobServerApi(object):
  ...
  def context(self, **kwargs):
    return self._root.post('contexts', params=kwargs, contenttype='application/octet-stream')

  def contexts(self, **kwargs):
    return self._root.get('contexts', params=kwargs, headers={'Accept': _JSON_CONTENT_TYPE})
  
  def upload_jar(self, data):
    return self._root.post('jars', data=data, contenttype='application/octet-stream')
