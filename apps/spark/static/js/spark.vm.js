...
function sparkViewModel() {
  ...
  self.modalUploadApp = function() {

//	  var uploader = new qq.FileUploaderBasic({
//	        //button: document.getElementById("uploadAppFormBtn"),
//	        action: '/spark/api/upload_app',
//	        fileFieldLabel: 'jar_file',
//	        multiple: false,
...
//	        onSubmit: function() {
//	        	alert('aa');
//	         // uploader._handler._options.action = '/spark/api/upload_app'; // + element.find('#new_column_name').val() + '"';
//	        }
//	      });	  	
	
//	var data = $("#uploadAppForm").serialize();
//    var request = {
//      url: '/spark/api/upload_app',
//      dataType: 'json',
//      type: 'POST',
//      success: function(data) {
//    	$("#uploadAppModal").hide();
