...
<script type="text/html" id="step-1">
  <div class="control-group">
    ...
    <div class="controls">
      <input data-bind="value: name" name="name" type="text" placeholder="${_('Name of collection')}" />
    </div>
  </div>
</script>
...
<script type="text/html" id="step-2">
  <formset data-bind="foreach: collection.fields">
    <div class="control-group">
      <label for="name" class="control-label">${_("Name")}</label>
      <div class="controls">
        <input name="name" type="text" placeholder="${_('Name of field')}" />
      </div>
    </div>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input name="name" type="text" placeholder="${_('Type of field')}" />
      </div>
    </div>
