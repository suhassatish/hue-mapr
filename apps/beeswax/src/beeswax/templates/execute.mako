...
<div id="parameter-selection" class="container-fluid hide section">
  <div class="row-fluid">
    <div class="card card-small">
...
<script type="text/javascript" charset="utf-8">
    ...
    $(window).on("resize", function () {
      ...
      resizeTimeout = window.setTimeout(function () {
        ...
        if (winWidth != $(window).width() || winHeight != $(window).height()) {
          viewModel.state.valueHasMutated();
          $("#navigator .card").css("min-height", ($(window).height() - 130) + "px");
          $("#navigatorTables").css("max-height", ($(window).height() - 260) + "px").css("overflow-y", "auto");
  ...
  $(document).ready(function() {
    routie({
      ...
      'query/execute': function() {
        if (!viewModel.query.isParameterized() || !viewModel.query.query()) {
          routie('query');
        }
        showSection('parameter-selection');
      },
      '': function() {
        routie('query');
      }
  ...
  // @TODO: Add parameterization screen and submit with parameters
  // @TODO: Save
  // @TODO: Save As
  ...
  // @TODO: Close
  // @TODO: Stop operation
  // @TODO: Readd filebrowser to file resources.
  // @TODO: Readd tooltips for execute query button
  // @OTOD: Readd download query for impala
  // @TODO: Type ahead for settings
</script>
