...
from oozie.conf import EDITOR_COORDINATOR_USE_CRON
...
def create_coordinator(request, workflow=None):
  ...
  editor_coordinator_use_cron = EDITOR_COORDINATOR_USE_CRON.get()
  ...
  if request.method == 'POST':
    ...
    if coordinator_form.is_valid():
      ...
      if editor_coordinator_use_cron:
  ...
  return render('editor/create_coordinator.mako', request, {
    ...
    'editor_coordinator_use_cron': editor_coordinator_use_cron,
  })
