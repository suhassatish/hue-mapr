        ...
        <div class="card-body">
          ...
          <div class="row-fluid" data-bind="visible: collections().length == 0 && !isLoading()">
            <div class="span10 offset1 center importBtn" style="cursor: pointer">
              ...
              <h1 class="emptyMessage">${ _('There are currently no collections defined.') }<br/><a href="/collectionmanager/import">${ _('Click here to add') }</a> ${ _('one or more.') }</h1>
            </div>
          </div>
          ...
          <div class="row-fluid">
            <div class="span12">
              <p>
                <ul id="collections" data-bind="template: {name: 'collectionTemplate', foreach: filteredCollections}"></ul>
              </p>
            </div>
          </div>
        </div>
