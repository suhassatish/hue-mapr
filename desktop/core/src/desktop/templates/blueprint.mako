  ...
  <div class="row-fluid">
    <div class="span6">
      <div class="card card-home" style="margin-top: 0">
        <h2 class="card-heading simple">${_('Line chart')}</h2>
    ...
    <div class="span6">
      <div class="card card-home" style="margin-top: 0">
        ...
        <h2 class="card-heading simple">${_('Bar chart')}</h2>
    ...
    <div class="span6">
      <div class="card card-home" style="margin-top: 0">
        <h2 class="card-heading simple">${_('Point chart')}</h2>
    ...
    <div class="span6">
      <div class="card card-home" style="margin-top: 0">
        ...
        <h2 class="card-heading simple">${_('Pie chart')}</h2>

        <div class="card-body">
          <p>
          <div id="piesample"></div>
          </p>
        </div>
      </div>
    </div>
